...
public class KMeansDatasetGenerator {
    public static void main(String[] args) {
        ...
        saveDatasetToText(dataset, filePath);
    ...
    private static void saveDatasetToText(double[][] dataset, String filePath) {
        try (FileWriter writer = new FileWriter(filePath)) {
            ...
            System.err.println("Failed to save dataset to text file.");
            e.printStackTrace();
        }
    }
}
